#This script scrapes search results for movies off of putlocker, and also
#retrieves the number of versions of the movie that are available.
...
data = data[data['putlocker_url'] != 'MULTI_URL_ERROR']



def pull_alt_version_count(movie_name, year):
    url1, url2 = go_to_movie(movie_name, year)
